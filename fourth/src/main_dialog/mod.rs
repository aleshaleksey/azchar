...
pub(crate) struct AZCharFourth {
    ...
    db_path: String,
    cfg_path: String,
    pub(crate) dbs: Option<LoadedDbs>,
    pub(crate) char_list: Vec<CharacterDbRef>,
    ...
    pub(crate) error_dialog: Option<String>,
    dice_dialog: Option<RollResults>,
    pub(crate) file_dialog: flow_control::For,
}
...
impl AZCharFourth {
    pub(crate) fn with_frame(f: Frame) -> Self {
        ...
        Self {
            ...
            error_dialog: None,
            dice_dialog: None,
            file_dialog: flow_control::For::None,
        }
    }
}
                ...
                egui::ScrollArea::vertical().show(ui, |ui| {
                    ...
                    if !self.hidden_char_list {
                        ...
                        for i in 0..self.char_list.len() {
                            ...
                            ui.horizontal(|ui| {
                                let c = self.char_list[i].to_owned();
                        ...
                        if ui.button("Import Character (JSON)").clicked() {
                            self.file_dialog = flow_control::For::ImportCharacter;
                        }
